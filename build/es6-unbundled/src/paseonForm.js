define(["exports","../node_modules/lit-element/lit-element.js","../node_modules/lit-html/directives/style-map.js","../node_modules/lit-html/directives/class-map.js"],function(_exports,_litElement,_styleMap){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.default=void 0;class PaseonForm extends _litElement.LitElement{static get properties(){return{recipient_email:{type:String},form_obj:{type:Object},msgSuccess:{type:Boolean},recipient_email:{type:String},loading:{type:Boolean},formSchema:{type:Object},name:{reflectToAttribute:!0,type:String,noAccessor:!0}}}constructor(){super();this.loading=!1;this.form_obj={name:"",from:"",subject:"",body:""};this.name="";this.formSchema=null;this.msgSuccess=!1}firstUpdated(){this.initFetch()}initFetch(){fetch(`http://localhost:3001/campaign/get_campaign_details/${167}`).then(response=>{if(200===response.status){return response.json()}return response.json()}).then(response=>{this.formSchema=response})}handleSetInputValues(e){return this.form_obj[e.target.name]=e.target.value}submitForm(e){e.preventDefault();this.loading=!0;let data=this.form_obj;data.recipient_email=this.recipient_email;fetch("https://paseonemailservice.azurewebsites.net/api/paseon",{headers:{"Content-Type":"application/json"},method:"POST",body:JSON.stringify(data)}).then(response=>{if(200===response.status){this.loading=!1;this.msgSuccess=!0;let self=this;setTimeout(function(){self.msgSuccess=!1},2e3)}else{console.log("error")}}).then(()=>{})}renderSuccess(){return _litElement.html`
        ...
        `}renderFormField(field){let obj={input:_litElement.html`
                    <input 
                        type="${field.type}"
                        name="${field.name}"
                    />
                `,select:_litElement.html`
                    <select>
                        
                    <select/>
                `,textarea:_litElement.html`
                    <textarea
                        type="${field.type}"
                        name="${field.name}"
                    />
                `};return obj[field.tag]}renderCustomForm(){console.log(this.formSchema.data_schema[0].form_schema);return _litElement.html`
            <style>
            ...
            <div>
                ...
                >
                ${this.formSchema.data_schema[0].form_schema.map(field=>{return _litElement.html`
