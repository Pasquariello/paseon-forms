import{LitElement,html}from"../node_modules/lit-element/lit-element.js";import{styleMap}from"../node_modules/lit-html/directives/style-map.js";import{classMap}from"../node_modules/lit-html/directives/class-map.js";class BaiscForm extends LitElement{static get properties(){return{recipient_email:{type:String},form_obj:{type:Object},msgSuccess:{type:Boolean},recipient_email:{type:String},loading:{type:Boolean}}}constructor(){super();this.loading=!1;this.form_obj={name:"",from:"",subject:"",body:""};this.msgSuccess=!1}handleSetInputValues(e){return this.form_obj[e.target.name]=e.target.value}renderBasicContactForm(){return html`
